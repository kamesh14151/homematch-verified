        ...
        <div className="mx-auto w-full max-w-[350px]">
          <div className="mb-3">
            <h1 className="text-2xl font-bold tracking-tight text-foreground lg:text-[28px]">
              Create your RentVerify account
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Choose whether you&apos;re listing homes as an owner or searching
              as a tenant. You can always add more details later.
            </p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span
                    className={`text-sm font-medium ${
                      role === "tenant" ? "text-foreground" : "text-foreground"
                    }`}
                  >
                    Tenant
                  </span>
