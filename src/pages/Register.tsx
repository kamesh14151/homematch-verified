          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Building2 className={`h-6 w-6 ${role === "landlord" ? "text-primary" : "text-muted-foreground"}`} />
                  <span className={`text-sm font-medium ${role === "landlord" ? "text-primary" : "text-foreground"}`}>Landlord</span>
                ...
                >
                  <Users className={`h-6 w-6 ${role === "tenant" ? "text-primary" : "text-muted-foreground"}`} />
                  <span className={`text-sm font-medium ${role === "tenant" ? "text-primary" : "text-foreground"}`}>Tenant</span>
